...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post("Harry Potter","TDD For Fun and Profit", topic1, "Lorem ipsum dolor sit amet, consectetur " +
                ...
                "est laborum.");
        postRepo.save(post1);
        Post post2 = new Post("Fred Flinstone","Test the Fear Away", topic2, "Lorem ipsum dolor sit amet, consectetur " +
                "adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim" +
                " veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis " +
                "aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. " +
                "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id " +
                "est laborum.");
        postRepo.save(post2);
        Post post3 = new Post("Harry Potter","Unit Tests and You", topic3, "Lorem ipsum dolor sit amet, consectetur " +
                "adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim" +
                " veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis " +
                "aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. " +
                "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id " +
        ...
        Hashtag hashtag1 = new Hashtag("firstHashtag");
        Hashtag hashtag2 = new Hashtag("secondHashtag");
        hashtag1.addPost(post1);


        hashtag2.addPost(post2);
        hashtag1.addPost(post3);
